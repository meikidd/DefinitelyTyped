...
declare namespace videojs {
    ...
    function use(
        type: string,
        middleware: (player: Player) => Middleware,
    ): void;
    ...
    interface EventedMixin {
         ...
         */
        off(
            targetOrType?: string | string[],
            typeOrListener?: (...args: any[]) => void,
    ...
    interface Middleware {
        ...
        setSource: (
            ...
            next: (err: any, next: (src: Tech.SourceObject) => void) => void,
        ) => void;
    }
    ...
    const Plugin: {
        ...
        registerPlugin<T extends typeof Plugin>(
            name: string,
            plugin: T,
        ): () => T;
    };
